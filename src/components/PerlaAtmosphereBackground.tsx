...
export const PerlaAtmosphereBackground: React.FC = () => {
  return (
    ...
    >
      ...
      {/* 4. 3D Radiant Pearlescent Spheres & Crystal Water Bubbles ("fo9a3at mtaa mee") */}
      
      {/* Top-Left: Large Radiant Pearl Sphere */}
      <div className="absolute -top-10 -left-10 sm:-top-8 sm:-left-8 w-36 h-36 sm:w-48 sm:h-48 pearl-sphere animate-float-1 z-1 opacity-90">
        <div className="absolute inset-0 rounded-full bg-gradient-to-tr from-[#D8C4BA]/20 via-transparent to-white/60 pointer-events-none" />
      </div>

      {/* Top-Center/Right: Crystal Translucent Water Bubble */}
      <div className="absolute top-20 right-[28%] sm:right-[32%] w-14 h-14 sm:w-20 sm:h-20 water-bubble animate-float-2 z-1">
      ...
      <div className="absolute top-36 right-[12%] w-8 h-8 sm:w-11 sm:h-11 water-bubble animate-float-3 z-1 opacity-85" />

      {/* Mid-Left: Floating Pearlescent Sphere */}
      <div className="absolute top-[38%] -left-6 sm:left-6 w-20 h-20 sm:w-28 sm:h-28 pearl-sphere animate-float-2 z-1 opacity-85" />
      ...
      <div className="absolute top-[55%] right-[8%] sm:right-[15%] w-16 h-16 sm:w-24 sm:h-24 water-bubble animate-float-3 z-1">
      ...
      {/* Bottom-Left: Large Shimmering Pearl Sphere */}
      <div className="absolute -bottom-12 -left-8 sm:bottom-12 sm:left-12 w-32 h-32 sm:w-44 sm:h-44 pearl-sphere animate-float-3 z-1 opacity-90" />
      ...
      {/* Bottom-Right: Radiant Pearl Sphere */}
      <div className="absolute -bottom-16 -right-10 sm:-bottom-10 sm:-right-8 w-36 h-36 sm:w-52 sm:h-52 pearl-sphere animate-float-1 z-1 opacity-90" />
